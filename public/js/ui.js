    ...
    tr.innerHTML = `
      ...
      <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
        ...
        <a
          ...
          class="transactions__action-btn text-green-600 hover:text-green-900 mr-3 inline-block align-middle"
        ...
        <button
          class="transactions__action-btn text-indigo-600 hover:text-indigo-900 mr-3 inline-block align-middle"
          data-action="edit"
          data-id="${exp.id}"
        ...
        <button
          class="transactions__action-btn text-red-600 hover:text-red-900 inline-block align-middle"
          data-action="delete"
          data-id="${exp.id}"
